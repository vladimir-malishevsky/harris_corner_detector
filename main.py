...
descriptors_original_image = own.patch_descriptors(original_img_corners, original_img_corners)
descriptors_other_image = own.patch_descriptors(other_img_corners, other_img_corners)
